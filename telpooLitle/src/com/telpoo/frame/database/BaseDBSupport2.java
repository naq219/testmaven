...
public class BaseDBSupport2 extends SQLiteOpenHelper {
	...
	protected BaseDBSupport2(Context context) {
	...
	public static boolean init(String[] tables1, String[][] keys1, Context context, String db_Name, Integer db_Version) {
		...
		if (context == null)
			return false;
		if (instance == null) {
			instance = new BaseDBSupport2(context.getApplicationContext());
		}
	...
	public static BaseDBSupport2 getInstance(Context context) {
		if (context == null)
			return null;
		if (instance == null) {
			instance = new BaseDBSupport2(context.getApplicationContext());
